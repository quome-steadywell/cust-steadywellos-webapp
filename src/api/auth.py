...
def get_session_settings():
    ...
    if time_unit == "SECONDS":
        ...
        current_app.logger.info(
            f"Returning session settings: auto_logout={auto_logout_time}sec ({auto_logout_mins:.2f}min), warning={warning_time}sec ({warning_mins:.2f}min)"
        )
        ...
        current_app.logger.info(
            f"Returning session settings: auto_logout={auto_logout_time}min, warning={warning_time}min"
        )
