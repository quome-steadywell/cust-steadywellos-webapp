...
def fix_mary_johnson_data():
    ...
    # Set up basic logging before creating app to avoid file logging issues
    setup_basic_logging()
    
    # Import needed modules here to avoid import order issues
    import logging
    ...
    with app.app_context():
        try:
            ...
            try:
                ...
                print("This is normal during initial setup. Will retry later when tables are created.")
                return
            ...
            print(f"Error during Mary Johnson data fix: {str(e)}")
            if "relation" in str(e) and "does not exist" in str(e):
                print("Database tables don't exist yet. This script will be run again after tables are created.")
            else:
