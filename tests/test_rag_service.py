...
def mock_protocol():
    ...
    protocol.questions = [
        {
            "id": "q1",
            "text": "How would you rate your breathing difficulty today?",
            "type": "scale",
            "min": 0,
            "max": 10,
        },
        {
            "id": "q2",
            "text": "Have you noticed any swelling in your ankles or legs?",
            "type": "boolean",
        },
    ]
...
class TestRagService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.symptoms = {"breathing_difficulty": 7, "fatigue": 5, "swelling": 3}

        self.responses = {"q1": 7, "q2": True}
