...
from app.models.medication import MedicationRoute, MedicationFrequency
...
class MedicationSchema(Schema):
    ...
    route = fields.Str(required=True, validate=validate.OneOf([route.value for route in MedicationRoute]))
    frequency = fields.Str(required=True, validate=validate.OneOf([freq.value for freq in MedicationFrequency]))
