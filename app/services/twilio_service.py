...
from app.services.rag_service import analyze_call_transcript
...
def generate_call_twiml(call: Call) -> str:
    ...
    if call.call_type == 'assessment':
        ...
        # Verify identity
        gather = Gather(num_digits=1, action=url_for('calls.voice_webhook', _external=True, call_id=call.id, action='verify'), method='POST')
